...
d = '<p style="font-family:Courier; color:Green; font-size: 30px;"><b>Predicting the input data using Support Vector Machine</b></p>'
...
if(prediction[0] == 0):
   ...
   print('Not Diabetic')
   d = '<p style="font-family:Courier; font-style:Bold; color:Blue; font-size: 30px;"><b>You are not DIABETIC</b></p>'
   st.markdown(d, unsafe_allow_html=True)

else:
   print('Diabetic')  
   d = '<p style="font-family:Courier; font-style:Bold; color:Red; font-size: 30px;"><b>You are DIABETIC</b></p>'
   st.markdown(d, unsafe_allow_html=True)

   st.write('Follow diet chart as per your doctor instructions')
   st.image("diet.jpg")